object DOrdenCarga: TDOrdenCarga
  ...
  object QResumenOrden: TQuery
    ...
    SQL.Strings = (
        ...
        'select producto_ocl, envase_ocl, tipo_palets_ocl tipo_palet_ocl,' +
        ' sum(cajas_ocl) cajas_ocl, sum(n_palets_ocl) palets_ocl'
      'from frf_orden_carga_l'
      'where orden_ocl = :orden'
      'group by producto_ocl, envase_ocl, tipo_palets_ocl'
      'order by producto_ocl, envase_ocl, tipo_palets_ocl')
    Left = 280
    Top = 480
    ParamData = <
      item
  ...
  object QGetProducto: TQuery
    ...
    SQL.Strings = (
      'select producto_p '
      'from frf_productos'
      'where producto_base_p = :producto'
      'order by producto_p ')
    Left = 112
    Top = 544
    ParamData = <
